...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <!-- Modal -->
            <div class="modal fade" id="reportModal1" tabindex="-1" role="dialog" aria-labelledby="modalTitleId"
                aria-hidden="true">
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-body report-content-user">
                                    ...
                                    <tbody>
                                        ...
                                        @if ($contractID == $contract_id)
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="1" class="text-right"><b>Total Labor Paid:</b></td>
                                            ...
                                            @else
                                            <tr>
                                                <td colspan="9" class="text-center">No worker
                                                    information
                                                    found.</td>
                                            </tr>
                                        @endif
